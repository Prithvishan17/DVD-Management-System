...
<head>
  ...
  <title>Buntong DVD Shop : Orders</title>
  <!-- Bootstrap -->
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
      <input name="orderdate" type="text" readonly class="form-control" id="orderdate" placeholder="Order Date" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_date']; ?>" required>
          </div>
        </div>
  ...
  <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
    ...
    <table class="table table-striped table-bordered">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "SELECT * FROM tbl_orders_a181068, tbl_staffs_a181068_pt2, tbl_customers_a181068_pt2 WHERE ";
        $sql = $sql."tbl_orders_a181068.fld_staff_id = tbl_staffs_a181068_pt2.fld_staff_id and ";
        $sql = $sql."tbl_orders_a181068.fld_customer_id = tbl_customers_a181068_pt2.fld_customer_id LIMIT $start_from, $per_page";
    ...
    <nav>
      <ul class="pagination">
        ...
        try {
          $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
          $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_orders_a181068");
          $stmt->execute();
          $result = $stmt->fetchAll();
