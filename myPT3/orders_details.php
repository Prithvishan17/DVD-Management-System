...
<head>
  ...
  <title>Buntong DVD Shop : Order Details</title>
  <!-- Bootstrap -->
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a181068, tbl_staffs_a181068_pt2,
          tbl_customers_a181068_pt2 WHERE
    ...
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
            ...
            ?>
              <option value="<?php echo $productrow['fld_product_id']; ?>"><?php echo $productrow['fld_product_name']." | Genre: ".$productrow['fld_product_genre']; ?></option>
            <?php
            }
            $conn = null;
            ?>
